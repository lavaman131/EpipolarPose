...
def from_worldjt_to_imagejt(
    joint_num, rot, keypoints, trans, fl, c_p, rect_3d_width, rect_3d_height, mpii=False
):
    ...
    for n_jt in range(0, joint_num):
        ...
        pt_2d[n_jt, 0], pt_2d[n_jt, 1] = CamProj(
            pt_3d[n_jt, 0], pt_3d[n_jt, 1], pt_3d[n_jt, 2], fl[0], fl[1], c_p[0], c_p[1]
        )
    ...
    rect2d_l, rect2d_t = CamProj(
        rect3d_lt[0], rect3d_lt[1], rect3d_lt[2], fl[0], fl[1], c_p[0], c_p[1]
    )
    rect2d_r, rect2d_b = CamProj(
        rect3d_rb[0], rect3d_rb[1], rect3d_rb[2], fl[0], fl[1], c_p[0], c_p[1]
    )
