...
RAT7M_NAMES = [str(i) for i in range(20)]
...
class JointsIntegralDataset(Dataset):
    def __init__(self, cfg, root, image_set, is_train):
        ...
        self.rect_3d_width = 2000.0
        self.rect_3d_height = 2000.0
        ...
        self.occluders = (
            load_occluders(cfg.DATASET.VOC)
            if cfg.DATASET.OCCLUSION and is_train
            else None
        )
