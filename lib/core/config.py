...
MODEL_EXTRAS = {"pose3d_resnet": POSE_RESNET}
...
config.DATASET.OCCLUSION = (
    False  # Assign True if you want to use occlusion augmentation proposed by
)
...
config.DATASET.Z_WEIGHT = 1.0  # weighting parameter for z axis
